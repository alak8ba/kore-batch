...
KORE BATCH est issu de plusieurs années de développement batch en production chez SNCF (2016–2019), sur des projets de traitement de données de pensions, notifications et flux d'alimentation.
